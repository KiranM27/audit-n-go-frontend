...
public class AddOutletTest {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement outletName = driver.findElement(
				By.xpath("/html/body/div[1]/div/div[2]/main/div[1]/div/div/div/div/div[2]/div/div/div/form/div[1]/div/input"));
		outletName.sendKeys("Test Outlet");
		Thread.sleep(1000);

		WebElement outletEmail = driver.findElement(
				By.xpath("/html/body/div[1]/div/div[2]/main/div[1]/div/div/div/div/div[2]/div/div/div/form/div[2]/div/input"));
		outletEmail.sendKeys("TestOutlet@mail.com");

		Thread.sleep(2000);

		driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div[1]/div/div/div/div/div[2]/div/div/div/button"))
				.click();
		Thread.sleep(2000);
