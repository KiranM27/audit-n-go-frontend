...
public class FullFlow {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div/div/div[1]/div/div/div/input")).sendKeys(Keys.DOWN);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div/div/div[1]/div/div/div/input")).sendKeys(Keys.ENTER);
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div/div/div[2]/div/div/div/div/button[2]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div/div/div[2]/div/div/div/input")).sendKeys("Dominos");
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div/div/div[2]/div/div/div/input")).sendKeys(Keys.DOWN);
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div/div/div[2]/div/div/div/input")).sendKeys(Keys.ENTER);
        Thread.sleep(1000);
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div/div/div[3]/div/div/div/input")).sendKeys(Keys.DOWN);
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div/div/div[3]/div/div/div/input")).sendKeys(Keys.ENTER);
        Thread.sleep(1000);
        //Select deadline
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div/div/div[4]/div/div/input")).sendKeys("30/04/2021");
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div[2]/div/header/div/div/div/button[1]")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/main/div[3]/div/div[1]/div/div/p/div/div/div/div[2]/div[2]/div/div/div/div/div/div[1]/div[1]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[1]/div/div[2]/div[1]/div/label/span[1]/span[1]/span[1]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[1]/div/div[2]/div[1]/div/label/span[1]/span[1]/span[1]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[1]/div/div[2]/div[1]/div/label/span[1]/span[1]/span[1]")).click();
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[4]/div/div/form/input")).sendKeys("Hi I can type messages here :)");
        Thread.sleep(1000);
