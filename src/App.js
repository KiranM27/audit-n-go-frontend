...
import AboutTenant from "./components/about/AboutTenant";
...
import AuditViewTenant from "./components/auditview/AuditViewTenant";
import {
      ...
      <Router>
        <Switch>
          ...
          <div>
            ...
            <Route path="/aboutTenant" component={AboutTenant} />
            <Route path="/auditDetail/:audit_id" component={AuditView} />
            <Route
              path="/auditDetailTenant/:audit_id"
              component={AuditViewTenant}
            />
