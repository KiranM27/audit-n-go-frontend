...
function AuditInitialView(props) {
  ...
  const [outletOptions, setOutletOptions] = useState(["Test Item 1", "Test Item 2"])
    ...
    <div>
        ...
        <main>
            <Container maxWidth="sm">
                ...
                <Typography variant="subtitle1" align="center" color="textPrimary" gutterBottom style={{paddingBottom: 20}}>
                ...
                <Grid container spacing={2} justify="center">
                    ...
                    <Grid style={{paddingBottom:10}}>
                        <RenderOutletSelect status = { status } outletOptions={ outletOptions } 
                            setSelectedOutlet = { setSelectedOutlet } setStatus = {setStatus }/>
                    </Grid>
                    <Grid style={{paddingBottom:10}}>
                        <RenderAuditTypeSelect status = { status } setStatus = {setStatus } 
    ...
    return(
        <Autocomplete
            ...
            onChange={(e,v) => {
                ...
                props.setStatus(3)}}
            renderInput={(params) => <TextField {...params} label="Audit type" variant="outlined" />}
        /> 
    )
  }
  else {
...
function RenderButton(props) {
  ...
  if (props.status === 3 && props.selectedInstitution != 0 
    && props.selectedOutlet != 0 && props.selectedAuditType != "") {
    return(
      <div>
          <ButtonGroup>
