...
let captcha_value = '';
let captcha_number = '';
let LoadCanvasTemplate_HTML = "<div><canvas id=\"canv\"></canvas><div><a id=\"reload_href\"  style=\"cursor: pointer; color: white\">Reload Captcha</a></div></div>";
...
export const loadCaptchaEnginge = (numberOfCharacters) => {
    ...
    ctx.fillStyle = "rgba(0, 0, 200, 0.01)";
