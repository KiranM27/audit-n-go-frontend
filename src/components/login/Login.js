...
import { loadCaptchaEnginge, LoadCanvasTemplate, validateCaptcha } from "./Captcha";
      ...
      <div class="form-structor">
        <div class={`signup ${showLogin ? "" : "slide-up"}`}>
          ...
          <div class="form-holder">
            <form>
            <input type="email" autocomplete='username' class="input" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} />
            <input type="password" autocomplete='current-password' class="input" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} />
            </form>
          </div >
