...
function RenderCard(props) {
  ...
  const isSmallScreen = useMediaQuery((theme) =>
    themeAbout.breakpoints.down("sm")
  );
    ...
    <Card className={classes.root}>
      <div className={classes.details}>
        ...
        <div className={classes.controls}>
          <IconButton
            aria-label="Insta"
            onClick={() => window.location.assign(props.instaURL)}
          >
            <InstagramIcon />
          </IconButton>
          <IconButton
            aria-label="GitHub"
            onClick={() => window.location.assign(props.githubURL)}
          >
            <GitHubIcon />
          </IconButton>
          <IconButton
            aria-label="LinkedIn"
            onClick={() => window.location.assign(props.linkedinURL)}
          >
            <LinkedInIcon />
          </IconButton>
        </div>
