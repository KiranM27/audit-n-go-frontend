                    ...
                    <Grid container spacing={2} justify="center">
                        ...
                        <Grid>
                            <div style={{paddingBottom:20}}>
                                ...
                                setSelectedOutlet = { setSelectedOutlet } setStatus = { setStatus } setviewAll= { setviewAll }/>
                            </div>
                        </Grid>
                    </Grid>
                </div>
...
function RenderTable(props){
    if (props.viewAll === true){
        return (
            <TableAuditView selectedOutlet={0}/>
        )
    }else if (props.status == 2 && props.selectedInstitution != 0 && props.selectedOutlet != 0){
        return (
            <TableAuditView selectedOutlet={props.selectedOutlet}/>
        )
    }else{
        return null;
    }
